...
def main():
    ...
    pytorch_number_reader.main()
    
    # 4. モデル比較
    print("\n=== ステップ4: モデル比較 ===")
    pytorch_number_reader.compare_with_sklearn()
    
    print(f"\n=== 処理完了 ===")
    print(f"PyTorch結果は result_pytorch.csv に保存されました")
    print(f"モデル比較結果は model_comparison.csv に保存されました")
